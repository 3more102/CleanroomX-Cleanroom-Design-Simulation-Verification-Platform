...
- Preserves v0.21 automatic Darcy-friction workflows and v0.22 HVAC/fan operating-airflow consistency.
- Keeps loop solving bounded to explicit fixed edge resistances; geometry/friction inference inside the mesh, leakage, dampers, controls, fan coupling, compressibility, and transient behavior remain outside scope.
