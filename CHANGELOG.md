...
## Unreleased bounded project-file ingestion — 2026-09-26
...
- Uses a bounded binary read with a second byte-limit check so file growth between the initial stat and read cannot bypass the ceiling.
