...
## v0.12 fan-driven passive parallel-network integration — 2026-09-23

- Coupled the v0.11 bounded fan-curve solver to the v0.9 passive parallel-path resistance model.
