...
## v0.27 variable-friction loop solving — 2026-09-23
...
- Supports configurable resistance-closure tolerance, update relaxation, outer-iteration limits, and inner mass-balance/Newton tolerances.
...
- Bumped package/runtime metadata to v0.27.0 while leaving the v0.26 fan/loop-network workflow fixed-resistance.
