...
- Hardens diagnostics export safety by rejecting `--output` paths that alias the source project or a declared external engineering dependency, with regressions proving protected input bytes remain unchanged.
