...
- Closes an autosave completion-callback race by retaining coordinator ownership of a completed Future until its callback finalizes state, rejecting stale callbacks, and requiring no Future/active/pending request before idle is reported; PR #479 head `4a802f43be7bc891e2c4de90b631ddea7c1fa9e4` passed CI #1565 / `36184210616`.
