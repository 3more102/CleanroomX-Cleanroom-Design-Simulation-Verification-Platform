...
- Executes parsed dossier payloads directly through the shared service, avoiding a temporary manifest and preserving read-only source-directory compatibility.
