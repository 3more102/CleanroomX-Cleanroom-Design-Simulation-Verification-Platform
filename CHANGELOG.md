...
- Preserves v0.21 automatic Darcy-friction screening as a separate bounded path/tree capability; the loop solver intentionally uses explicit fixed edge resistances.
