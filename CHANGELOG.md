...
- Hardens diagnostics export safety by rejecting `--output` paths that alias the source project, with regression coverage proving the project bytes remain unchanged.
