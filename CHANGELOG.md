# Changelog
## v0.70 bounded bisection decision-trace provenance — 2026-09-24
...
- Surfaces trace evidence in standalone fan-loop, nonlinear uncertainty, and engineering-dossier reports while preserving v0.69 bidirectional residual-topology evidence, v0.68 scale-aware candidate separation, and v0.67 terminal bisection-invariant evidence.
