...
## v0.15 fan-driven passive parallel-network integration — 2026-09-23
...
- Kept this distinct from v0.14 reference-flow fan/duct integration: v0.15 solves the passive branch split from common pressure instead of holding reference flow fractions fixed.
