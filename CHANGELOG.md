...
- Recomputes fan pressure from the selected supplied interpolation segment and system pressure from a fresh nonlinear loop solve, verifies every retained fan-minus-system residual against that independent replay, and independently classifies each L/H/T decision from the recomputed midpoint residual.
