# Changelog
## v0.66 bisection implementation-invariant audit — 2026-09-24
...
- Records whether the active terminal bracket still preserves the strict positive/negative residual sign change and whether the accepted airflow is exactly the active bracket midpoint within floating-point comparison tolerance.
- Records the number of completed binary contraction steps, the iteration-implied width fraction of the original supplied segment, the actual width fraction, and their absolute floating-point consistency error.
...
- Surfaces invariant evidence in standalone fan-loop, nonlinear uncertainty, and engineering-dossier reports.
