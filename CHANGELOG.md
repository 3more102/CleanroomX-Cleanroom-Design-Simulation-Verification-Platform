...
- Preserves v0.21 automatic Darcy-friction support while keeping this loop solver on explicit fixed edge resistances.
- Keeps geometry/friction inference inside the loop solve, leakage, dampers, controls, fan coupling, compressibility, and transient behavior outside this bounded solver.
