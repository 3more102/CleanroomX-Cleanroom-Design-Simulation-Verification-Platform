...
- Hardens recovery autosave completion ownership so a finished `Future` remains coordinator-owned until its callback finalizes shared state; PR #479 head `4a802f43be7bc891e2c4de90b631ddea7c1fa9e4` passed CI #1565 / `36184210616` with **1002 passed** on Python 3.11/3.12/3.13.
