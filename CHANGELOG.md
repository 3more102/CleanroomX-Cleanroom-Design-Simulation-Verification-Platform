...
## v0.17 recovery uncertainty qualification — 2026-09-23
...
- Kept all target concentrations, time limits, and uncertainty inputs project-supplied; no ISO class or universal conformity threshold is embedded.
