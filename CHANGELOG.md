...
- Adds **Analysis → Run History...** with explicit INPUT MATCH/HISTORICAL INPUT labeling from the live editor input hash, read-only result/report/diagnostics inspection, and explicit historical run-bundle export.
