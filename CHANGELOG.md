...
- Makes room-pressure coloring and labels consume a fresh completed verification result when available, then fall back to configured observed pressure and explicit spatial pressure without inventing evidence.
