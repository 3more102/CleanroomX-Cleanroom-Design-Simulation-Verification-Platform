...
The loader rejects malformed JSON, non-finite constants, an unexpected schema, invalid schema versions, unsupported analysis kinds, non-object analysis inputs, duplicate analysis ids, and invalid active-analysis references. CleanroomX does not silently reinterpret unknown future formats.
