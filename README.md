...
- Independent bisection midpoint-residual model rechecking for v0.80, freshly re-solving the variable-friction network at every retained midpoint, comparing recorded versus recomputed fan-minus-system residuals, and auditing L/H/T semantics against the recomputed value with exact uncertainty-corner provenance.
