...
- Iteration-limit root-search provenance for bounded bisection, retaining the remaining signed-residual bracket after the final budgeted evaluation plus binary-contraction invariant evidence, without accepting a failed midpoint as an operating point.
