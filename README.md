...
- Bisection trace midpoint pressure-arithmetic auditing for v0.80, retaining midpoint fan/system pressures, independently recomputing fan-minus-system residuals, and propagating exact violating iterations, uncertainty-corner indices, and worst arithmetic-error provenance.
