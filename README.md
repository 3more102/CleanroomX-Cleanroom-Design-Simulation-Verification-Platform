...
- Terminal-bracket pressure-component replay for v0.84, retaining and independently replaying low/high fan, loop-network, and system pressures on solved final brackets and post-decision iteration-limit remaining brackets, including the newly created endpoint after the last budgeted L/H update.
