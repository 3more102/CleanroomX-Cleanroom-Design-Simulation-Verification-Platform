...
- Independent bisection trace raw-state auditing for v0.78, recomputing strict residual bracketing and arithmetic midpoint geometry from recorded numeric fields, checking stored trace flags against those recomputed facts, and propagating exact violation provenance across uncertainty and dossier reporting.
