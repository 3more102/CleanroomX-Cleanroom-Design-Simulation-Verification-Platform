...
- Bisection trace pressure-component residual auditing for v0.80, retaining low/high/midpoint fan and system pressures, independently recomputing each stored fan-minus-system residual from those components, and propagating exact violation and worst-error provenance.
