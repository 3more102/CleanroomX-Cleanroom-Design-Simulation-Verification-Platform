...
- Bisection decision-predicate auditing for v0.78, independently checking each retained L/H/T choice against the recorded midpoint residual sign and the configured operating-pressure tolerance, with exact nonlinear uncertainty-corner violation provenance.
