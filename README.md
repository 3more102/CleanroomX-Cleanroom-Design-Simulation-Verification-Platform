...
- Bisection trace pressure-component auditing for v0.80, retaining midpoint fan/system pressure, checking complete operand coverage, independently recomputing residual identity, auditing L/H/T decisions against the recomputed residual, and propagating exact violation/worst-error provenance.
