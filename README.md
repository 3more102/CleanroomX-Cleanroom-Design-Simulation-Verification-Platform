...
- Bisection trace origin-to-terminal replay for v0.76, anchoring the first trace bracket to the selected supplied fan-curve segment and reconstructing every retained L/H/T decision through the solved or iteration-limit terminal bracket.
