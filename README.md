...
- Bisection trace residual-component auditing for v0.80, retaining low/high/midpoint fan and system pressures, independently rebuilding each fan-minus-system residual, checking component-based L/H/T decision semantics, and propagating exact mismatch provenance across uncertainty and dossiers.
