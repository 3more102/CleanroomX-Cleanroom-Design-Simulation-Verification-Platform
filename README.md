...
The v0.12 dossier hashes every referenced input with SHA-256, preserves component-specific fail/incomplete/indeterminate/not-checked states, and includes the integrated HVAC fan-curve duty result when configured. It is a traceability/reporting layer, not cleanroom certification or fan/equipment acceptance.
