...
- Complete nonlinear solver-provenance fingerprint replay for v0.91, extending the canonical hash to network/reference identity, inner Newton iteration metadata, mass-balance tolerance, variable-friction convergence/configuration, and chronological outer-iteration history while keeping named result collections order-invariant.
