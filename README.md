...
- Independent fan/system residual replay for v0.80, re-solving the loop at every exact supplied-segment bisection low/high/midpoint state and checking each retained fan-minus-system residual against the recomputed value, with exact uncertainty-corner violation and worst-error provenance.
