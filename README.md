...
- Terminal-bracket pressure-component replay for v0.85, retaining and independently replaying low/high fan, loop-network, and total system pressures on solved final brackets and post-decision iteration-limit remaining brackets, with exact terminal mismatch records and tied worst-error provenance.
