...
Next milestones are richer engineering reports, duct/network pressure-loss modeling, uncertainty propagation into thermal and recovery acceptance workflows, and later a desktop/web UI plus CFD adapters.
