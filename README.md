...
The v0.22 solver handles connected meshes with arbitrary loops using explicit fixed edge laws `ΔP = R·Q·|Q|` and balanced node injections. It reports signed flow direction, relative node pressures, continuity residuals, and pressure-law residuals. It does not infer duct geometry or couple the loop to a fan curve. See docs/LOOPED_NETWORK_SOLVER.md.
