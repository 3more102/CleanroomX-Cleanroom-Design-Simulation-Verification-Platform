...
Next milestones are integrating fan-speed studies into engineering dossiers, general looped-network solving research including variable-friction pressure balancing, and later a desktop/web UI plus CFD adapters.
