...
Next milestones are pressure-balanced nonlinear airflow-network solving, uncertainty propagation into thermal and recovery acceptance workflows, richer engineering reports, and later a desktop/web UI plus CFD adapters.
