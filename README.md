...
- Independent retained-midpoint audit for v0.78, recomputing every trace midpoint directly from its recorded low/high airflow endpoints, retaining exact midpoint consistency error, and propagating violation/worst-error provenance without trusting the stored midpoint-validity flag.
