...
- Bisection residual pressure-chain auditing for v0.80, retaining low/high/midpoint fan and total-system pressures for every bounded-bisection step, recomputing each fan-minus-system residual from those pressure components, and propagating exact mismatch provenance without re-solving the network.
