...
The current release metadata is **CleanroomX v0.99.0**. It is a verified direct descendant of clean v0.91 head `cefcbc0b1c83ce041c5ab3da999173e281ddddfb` and continues the integrated solver/provenance line through the desktop-application work without replacing validated backend workflows. v0.99 continues from the integrated v0.98 desktop release on `main` and hardens plotted fan/system output plus GUI export error handling without replacing validated backend workflows.
...
| v0.99 | backend-evidence fan/system plotting, labeled multi-series rendering, and guarded GUI exports |
