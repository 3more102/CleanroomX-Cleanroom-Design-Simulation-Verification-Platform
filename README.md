...
Next milestones are broader cross-module consistency coverage, general looped-network solving research, fan/system control-law studies, and later a desktop/web UI plus CFD adapters.
