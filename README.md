...
The current release is **v0.97.0**. It is a clean descendant of integrated v0.95 commit `e62567d4e9c730ca1fb3439c38e340796208d4fe`, preserves the verified v0.91 → v0.92 → v0.93 → v0.94 → v0.95 provenance line, and carries the complete desktop application forward with end-to-end execution coverage for every GUI-exposed workflow, strict JSON, guarded background execution, unsaved-change protection, multi-analysis editor-state preservation, and result lifecycle cleanup.
