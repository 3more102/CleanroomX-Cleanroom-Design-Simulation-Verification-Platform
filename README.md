...
- Bisection trace residual-arithmetic auditing for v0.80, retaining midpoint fan/system pressure components, independently recomputing each midpoint fan-minus-system residual, and propagating component-coverage, mismatch-iteration, and worst-error provenance without changing solver acceptance semantics.
