...
- Full-bracket pressure-component replay for v0.83, retaining and independently replaying low/high endpoint fan, loop-network, and total system pressures on every bounded-bisection step so endpoint common-mode corruption is detectable as well as midpoint corruption.
