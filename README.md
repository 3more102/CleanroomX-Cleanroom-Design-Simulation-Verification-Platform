...
- Bounded-bisection decision-trace provenance for v0.72–v0.73, retaining every completed midpoint evaluation for both solved and iteration-limit searches as an auditable L/H/T sequence, using outcome-aware terminal checks, and propagating exact solved/iteration-limit trace coverage and violation provenance across uncertainty corners and dossier output.
