...
- Bisection iteration-limit terminal-state auditing for unresolved nonlinear searches, retaining the post-final-contraction signed bracket, last evaluated endpoint state, binary contraction evidence, and uncertainty-corner provenance without promoting the case to solved.
