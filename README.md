...
- Complete bounded-bisection decision-trace provenance for solved and iteration-limit nonlinear cases, retaining each midpoint bracket/residual evaluation, exact L/H/T endpoint decision, binary-width audit, transition chaining, and terminal-outcome consistency without fabricating an accepted point.
