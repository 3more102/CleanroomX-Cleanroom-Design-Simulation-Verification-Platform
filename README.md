...
- Manifest-driven integrated engineering dossiers with SHA-256 source fingerprints across verification, HVAC/fan-duty screening, recovery, room/qualification/thermal/psychrometric uncertainty, standalone fan/system studies, and fan/duct-network operating-point studies.
...
The v0.16 dossier hashes every referenced input with SHA-256 and now covers the v0.15 psychrometric-state uncertainty workflow and v0.14 fan/duct-network operating-point workflow in addition to the earlier analyses. It preserves component-specific fail, incomplete, indeterminate, not-checked, solved, outside-range, no-intersection, and unresolved-traceability states. The dossier is a traceability/reporting layer, not cleanroom certification or fan/equipment acceptance.
