...
Next milestones are richer engineering reports, extension of uncertainty propagation to pressure/thermal/recovery workflows, looped-network/pressure-balancing research, and later a desktop/web UI plus CFD adapters.
