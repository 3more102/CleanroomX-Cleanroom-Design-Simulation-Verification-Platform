...
- Independent bisection trace midpoint-residual recomputation for v0.80, re-running fan interpolation and the complete nonlinear variable-friction network at every retained midpoint, comparing the recorded fan-minus-system residual with the fresh model result, and propagating exact iteration/corner mismatch provenance.
