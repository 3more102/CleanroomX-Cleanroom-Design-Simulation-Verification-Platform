...
Next milestones are coupling psychrometric-state uncertainty into thermal sizing, richer engineering reports, uncertainty propagation into recovery acceptance workflows, general looped-network solving research, fan-curve integration with duct-network models, and later a desktop/web UI plus CFD adapters.
