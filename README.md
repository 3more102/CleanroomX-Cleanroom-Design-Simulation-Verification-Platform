...
Next milestones are richer engineering reports, arbitrary graph/network solving and balancing, uncertainty propagation into thermal and recovery acceptance workflows, and later a desktop/web UI plus CFD adapters.
