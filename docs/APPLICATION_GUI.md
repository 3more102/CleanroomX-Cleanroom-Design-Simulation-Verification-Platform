...
Check that the application catalog has unique keys, the public mapping matches the catalog, standard workflows have parser/runner bindings, custom consistency/dossier adapters obey their contracts, and every declared parser/runner/reporter binding is callable without opening a window:
