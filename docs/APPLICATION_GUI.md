...
Check that the application layer, GUI imports, registry structure, and every declared parser/runner/reporter binding are usable without opening a window:
