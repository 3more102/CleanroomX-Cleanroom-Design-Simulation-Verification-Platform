...
Check the application registry without opening a window. The check rejects duplicate workflow keys, enforces ordinary parser/runner and custom consistency/dossier adapter contracts, and resolves every declared parser/runner/reporter binding:
