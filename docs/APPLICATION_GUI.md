...
Check that the application catalog has unique keys, standard workflows have parser/runner bindings, custom consistency/dossier adapters obey their contracts, and every declared parser/runner/reporter binding is callable without opening a window:
