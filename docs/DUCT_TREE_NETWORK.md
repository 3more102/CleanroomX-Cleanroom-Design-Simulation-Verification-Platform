...
CleanroomX v0.7 adds deterministic branch-flow aggregation for a **rooted, acyclic supply duct tree** with fixed terminal airflow demands.
...
The v0.7 model uses **fixed terminal demands**. It does not solve:
