...
- `attention_required`: one or more configured checks failed, a recovery test is incomplete, an uncertainty result is indeterminate, or a standalone/integrated fan study has no intersection inside the supplied fan-curve range;
