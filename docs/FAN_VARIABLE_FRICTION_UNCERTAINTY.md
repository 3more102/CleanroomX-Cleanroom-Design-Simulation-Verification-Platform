...
v0.84 separately audits the accepted final operating point on every solved uncertainty corner, including supplied-point tolerance contacts with no bisection trace. Each solved corner retains fresh fan/loop/system/residual replay evidence, exact replay-violation and replay-nonconvergence corner indices, complete-solved-coverage status, and tied worst replay-error provenance.
