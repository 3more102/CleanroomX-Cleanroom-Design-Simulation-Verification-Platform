...
v0.84 additionally retains and independently replays the terminal bracket low/high pressure-component state for both solved bisection corners and iteration-limit corners. Uncertainty aggregation now reports exact terminal pressure-component replay violation corners and tied maximum terminal replay error, including the post-decision endpoint created by the final budgeted L/H update.
