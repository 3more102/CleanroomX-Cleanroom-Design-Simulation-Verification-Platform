...
- evaluated-corner fluid-air-power, shaft-power, electrical-input, and specific-fan-power ranges only when the corresponding metric is available at every solved evaluated corner;
...
- tie-aware source-corner provenance for every completely covered power-chain lower/upper extreme;
