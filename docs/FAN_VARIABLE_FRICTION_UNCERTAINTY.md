...
- configured solver-iteration checks for outer-Darcy, inner-Newton, and operating-point iteration budgets, including utilization ratio, remaining iterations, and complete-vs-partial coverage state;
