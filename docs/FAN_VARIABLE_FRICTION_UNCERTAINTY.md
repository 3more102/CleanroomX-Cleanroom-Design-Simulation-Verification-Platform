...
v0.86 propagates independent internal network-state fingerprint replay across the same evaluated uncertainty corners. The aggregate summary records consistent/violating corner indices while each retained bisection trace preserves low/midpoint/high canonical network-state replay evidence from fresh nonlinear solves.
