...
- evaluated-corner fluid-air-power, shaft-power, electrical-input, and specific-fan-power ranges only when that metric is available at every solved evaluated corner;
- complete/partial/unavailable power-metric coverage diagnostics with exact missing-corner indices;
- tie-aware source-corner provenance for every complete power-chain lower/upper extreme;
