...
CleanroomX v0.24 connects the existing duct-section pressure-loss model to the v0.23 fixed-resistance loop solver.
...
This means v0.24 is still a fixed-resistance network model. It does **not** iterate Reynolds number or Darcy friction factor as solved edge flow changes.
