...
Markdown summaries treat project names, analysis names/ids/kinds, source paths, and error text as untrusted presentation data and route them through the shared CleanroomX Markdown escaping boundary before rendering.
