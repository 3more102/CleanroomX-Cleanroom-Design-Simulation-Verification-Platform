...
CleanroomX v0.12 adds deterministic uncertainty envelopes for psychrometric air-state inputs and derived properties.
...
The v0.12 workflow is standalone. The existing thermal-uncertainty workflow continues to hold room and outdoor psychrometric states fixed until those models are explicitly coupled in a later milestone.
