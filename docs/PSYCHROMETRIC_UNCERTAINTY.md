...
The v0.15 standalone psychrometric CLI evaluates one bounded air state directly. The thermal-uncertainty workflow also accepts bounded room and outdoor air states and propagates their endpoint corners into makeup-air load and sensible-airflow intervals.
