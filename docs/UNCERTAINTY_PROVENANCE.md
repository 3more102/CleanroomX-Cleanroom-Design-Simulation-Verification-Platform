...
The v0.5 foundation covers room dimensions, supply airflow, derived room volume, derived supply ACH, and a project-configured minimum ACH requirement. Later workflows reuse the same provenance and deterministic interval principles for qualification checks and v0.9 thermal/HVAC sizing uncertainty.
...
CleanroomX v0.9 applies the same explicit-bound and provenance philosophy to preliminary thermal loads and airflow sizing. See `docs/THERMAL_UNCERTAINTY.md`.
