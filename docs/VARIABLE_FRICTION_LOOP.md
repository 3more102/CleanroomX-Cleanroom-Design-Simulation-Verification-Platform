...
CleanroomX v0.28 adds an optional outer iteration around the existing looped-network pressure solver.
...
The v0.28 workflow is for loop-network inputs that already use automatic friction from explicit:
