...
CleanroomX v0.29 adds an optional outer iteration around the existing looped-network pressure solver.
...
The v0.29 workflow is for loop-network inputs that already use automatic friction from explicit:
