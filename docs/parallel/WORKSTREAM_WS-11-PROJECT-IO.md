...
- **Implementation SHA before this coordination report:** `8e7374fd1d55f458735f6809ca7f7d6ad21aaac0`
...
- Apply the same project limit before revision hashing while preserving the historical `OSError` contract used by batch/bundle source-stability checks.
