...
_ANALYSES = (
    ...
    _spec("design_requirements", "Design requirements", "Design",
          ("design_requirements", "design_requirements_from_dict"),
          ("design_requirements", "analyze_design_requirements"),
          ("design_report", "markdown_design_requirements_report"),
          "Traceable cleanroom room-program requirements and derived design targets."),
    _spec("air_system_design", "Cleanroom air-system design", "Design",
          ("air_system_design", "air_system_design_from_dict"),
          ("air_system_design", "analyze_air_system_design"),
          ("design_report", "markdown_air_system_design_report"),
          "Requirement-driven preliminary airflow, balance, and terminal/FFU sizing proposals."),
    _spec("design_consistency", "Design consistency", "Design",
          ("design_consistency", "design_consistency_from_dict"),
          ("design_consistency", "analyze_design_consistency"),
          ("design_consistency", "markdown_design_consistency_report"),
          "Cross-check traceable requirements against preliminary air-system inputs without hidden semantic mappings."),
    ...
    _spec("pressure_network", "Room pressure network", "Networks",
          ("pressure_network_io", "pressure_network_from_dict"),
          ("pressure_network", "solve_room_pressure_network"),
          ("pressure_network_report", "markdown_pressure_network_report"),
          "Steady-state multizone room pressure, leakage-path, and cascade-target solution."),
