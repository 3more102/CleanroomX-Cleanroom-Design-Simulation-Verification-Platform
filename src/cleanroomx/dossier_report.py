    ...
    if result.get("fan_variable_friction_uncertainty_analyses"):
        ...
        for item in result[
            ...
            if search_summary is not None:
                ...
                trace_component_decision_count = search_summary.get(
                    "bisection_trace_pressure_component_decision_semantic_consistent_corner_count",
                    0,
                )
                trace_component_decision_violations = len(
                    search_summary.get(
                ...
                search_invariants = (
                    ...
                    f"trace-component-decision "
                    f"{trace_component_decision_count}/{trace_count}; "
                    f"component-decision violations "
                    f"{trace_component_decision_violations}; "
