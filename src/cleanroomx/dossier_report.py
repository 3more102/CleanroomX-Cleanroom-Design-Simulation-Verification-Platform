    ...
    if result.get("fan_variable_friction_uncertainty_analyses"):
        ...
        for item in result[
            ...
            if search_summary is not None:
                ...
                max_trace_pressure_identity_error = (
                    "—"
                    if trace_pressure_identity_error is None
                    else trace_pressure_identity_error["value"]
                )
                ...
                search_invariants = (
                    ...
                    f"trace-pressure-components "
                    f"{trace_pressure_component_complete_count}/{trace_count}; "
                    f"pressure-component gaps {trace_pressure_component_gaps}; "
                    f"trace-pressure-identity "
                    f"{trace_pressure_identity_count}/{trace_count}; "
                    f"pressure-identity violations "
                    f"{trace_pressure_identity_violations}; "
                    f"trace-pressure-decision "
                    f"{trace_pressure_decision_count}/{trace_count}; "
                    f"pressure-decision violations "
                    f"{trace_pressure_decision_violations}; "
                    f"max trace pressure identity error "
                    f"{max_trace_pressure_identity_error} Pa; "
