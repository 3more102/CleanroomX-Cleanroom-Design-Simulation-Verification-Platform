...
def analyze_supply_fan(
    ...
    return {
        ...
        "duct_pressure_source": duct_source,
        ...
        "scope_note": (
            ...
            "are explicit design inputs or calculated from the configured critical duct "
