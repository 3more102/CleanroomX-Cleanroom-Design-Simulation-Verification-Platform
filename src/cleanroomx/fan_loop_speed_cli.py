...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="cleanroomx-fan-loop-speed",
        description="Bounded fan-speed sweep over a fixed-resistance loop network",
    )
    parser.add_argument("study", help="Path to fan-speed/loop-network JSON")
    parser.add_argument(
        "--format",
...
def main() -> int:
    ...
    result = analyze_fan_loop_speed_study(load_fan_loop_speed_study(args.study))
    text = (
