...
_NETWORK_STATE_CANONICALIZATION = (
    "network-state-projection-sort-named-collections-normalize-signed-zero-"
...
def _network_state_projection(network: dict) -> dict:
            ...
            [
                {
                    ...
                    "net_edge_outflow_m3_h": row[
                        "net_edge_outflow_m3_h"
                    ],
    ...
    return _normalize_signed_zero(canonical_state)
