    ...
    *,
    ...
    return {
        ...
        "scope_note": (
            ...
            "fraction implied by its iteration. The audit independently "
            "recomputes strict sign-change and arithmetic-midpoint facts from "
            "the recorded numeric state and checks the stored flags against "
            "those recomputed facts. The origin replay additionally "
