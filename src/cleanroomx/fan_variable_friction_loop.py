...
def _fan_curve_supplied_point_residual_audit(
    ...
    return {
        ...
        "nearest_below_alternative_candidate_airflow_interval_gap_fraction_of_supplied_curve_span": None,
        "nearest_below_alternative_candidate_features": None,
        "nearest_above_alternative_candidate_airflow_interval_gap_m3_h": None,
        "nearest_above_alternative_candidate_airflow_interval_gap_fraction_of_supplied_curve_span": None,
        ...
        "scope_note": (
            ...
            "classified as below, overlapping, or above the selected airflow, "
...
def _with_selected_crossing_feature(
    ...
    *,
    ...
    nearest_below_gap_fraction = None
    nearest_below_features = None
    nearest_above_gap = None
    nearest_above_gap_fraction = None
    ...
    if selected_copy is not None:
        ...
        def _nearest_features(
            ...
            return (
                round(nearest_gap, 9),
                round(nearest_gap / supplied_curve_span, 12),
                nearest,
            )
        ...
        (
            nearest_below_gap,
            nearest_below_gap_fraction,
            nearest_below_features,
        ) = _nearest_features(below_features)
        (
            nearest_above_gap,
            nearest_above_gap_fraction,
            nearest_above_features,
        ) = _nearest_features(above_features)
