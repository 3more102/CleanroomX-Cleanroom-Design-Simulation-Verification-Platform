    ...
    if supplied_point_network_replay:
        lines.extend(
            [
                ...
                "",
                "- Evaluated supplied-point network-state fingerprints: "
                ...
                "- Independent network-state replay checks: "
                f"**{supplied_point_network_replay['replay_check_count']}**",
                "- All evaluated supplied-point network states match independent replay: "
                f"**{supplied_point_network_replay['all_evaluated_supplied_point_network_states_match_independent_replay']}**",
                "- Complete supplied-point network-state replay: "
                f"**{supplied_point_network_replay['complete_supplied_point_network_state_replay']}**",
                "- Supplied-point network-state replay violation points: "
                f"**{supplied_point_network_replay['violation_point_indices']}**",
