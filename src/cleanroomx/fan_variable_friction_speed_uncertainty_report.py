...
def markdown_fan_variable_friction_speed_uncertainty_report(
    ...
    lines.extend(
        [
            ...
            "",
            "| Speed ratio | Speed rpm | Status | Corners solved | "
            "Airflow envelope m³/h | System-pressure envelope Pa | "
            "Provenance complete |",
            "|---:|---:|---|---:|---|---|---|",
        ]
    )
    ...
    if unresolved:
        ...
        for case in unresolved:
            lines.append(
                ...
                f"`{case['nominal_status']}`, unresolved uncertainty "
                f"corners **{case['unresolved_corner_count']}**."
            )
