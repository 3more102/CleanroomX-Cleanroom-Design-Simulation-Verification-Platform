...
def _operating_point_search_resolution_summary(
    ...
    trace_residual_component_incomplete_corner_indices = [
        corner_index
        for corner_index, _corner, _evidence, audit in trace_cases
        if not audit.get("residual_component_audit_complete", False)
    ]
    ...
    return {
        ...
        "bisection_trace_residual_component_complete_corner_count": (
            len(trace_cases)
            - len(trace_residual_component_incomplete_corner_indices)
        ),
        "bisection_trace_residual_component_incomplete_corner_indices": (
            trace_residual_component_incomplete_corner_indices
        ),
