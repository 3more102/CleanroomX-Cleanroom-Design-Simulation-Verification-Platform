...
def analyze_fan_variable_friction_loop_uncertainty(
    ...
    return {
        ...
        "engineering_note": (
            ...
            "explicit fan/motor/VFD efficiency bounds for power-only "
            "propagation. "
            ...
            "specific-fan-power ranges plus their source corners. Explicit "
            "efficiency uncertainty, when supplied, is propagated across "
            "endpoint combinations after each solved aerodynamic corner and "
            "does not alter airflow or pressure in this model. No missing "
            "efficiency value or uncertainty is inferred. These "
