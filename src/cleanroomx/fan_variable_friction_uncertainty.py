...
def _operating_point_search_resolution_summary(
    ...
    trace_pressure_state_replay_violation_corner_indices = [
        corner_index
        for corner_index, _corner, _evidence, audit in trace_cases
        if audit.get(
    ...
    return {
        ...
        "bisection_trace_pressure_state_replay_consistent_corner_count": (
            len(trace_cases)
            - len(trace_pressure_state_replay_violation_corner_indices)
        ),
        ...
        "maximum_bisection_trace_midpoint_fixed_pressure_replay_error_pa": (
            _maximum_trace_geometry_metric_evidence(
        ...
        "maximum_bisection_trace_midpoint_residual_pressure_state_replay_error_pa": (
            _maximum_trace_geometry_metric_evidence(
