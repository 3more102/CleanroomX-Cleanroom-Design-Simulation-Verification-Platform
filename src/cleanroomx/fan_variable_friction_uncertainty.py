...
def _operating_point_search_resolution_summary(
    ...
    return {
        ...
        "scope_note": (
            ...
            "accepting or fabricating an operating point. Bounded-bisection "
            "decision traces additionally retain every completed midpoint "
            "evaluation for both solved and iteration-limit outcomes and "
            "audit iteration count, residual-sign bracketing, midpoint "
            "geometry, binary width contraction, bracket-transition chaining, "
            "and terminal outcome consistency."
        ),
    }
