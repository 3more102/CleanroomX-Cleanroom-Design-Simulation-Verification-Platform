...
def analyze_fan_variable_friction_loop_uncertainty(
    ...
    return {
        ...
        "engineering_note": (
            ...
            "only after hydraulic corner solves. Every hydraulic corner rebuilds "
            "the affected "
            ...
            "nominal efficiencies remain explicit user inputs; only "
            "explicitly configured efficiency bounds are treated as power-only "
            "uncertainty dimensions. No efficiency value or uncertainty is "
            "inferred. These "
