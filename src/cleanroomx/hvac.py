...
def analyze_hvac_project(project: HVACProject) -> dict:
    ...
    if project.fan_system is not None:
        ...
        supply_fan = analyze_supply_fan(
            ...
            network_duct_pressure_drop_pa=network_drop,
        )
    ...
    return {
        ...
        "engineering_note": (
            ...
            "to a fixed ACH, pressure offset, airflow surplus, filter pressure drop, duct "
            "geometry, friction factor, or fan duty."
        ),
    }
