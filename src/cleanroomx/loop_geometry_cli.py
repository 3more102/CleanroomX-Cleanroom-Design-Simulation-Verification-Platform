...
from .loop_geometry import solve_reference_geometry_loop
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description=(
            "Derive fixed loop resistance at explicit reference airflow and solve the mesh"
        ),
    )
...
def main() -> int:
    ...
    result = solve_reference_geometry_loop(
