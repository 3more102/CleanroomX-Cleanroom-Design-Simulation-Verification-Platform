...
class ProjectDocument:
    ...
    def _assert_analysis_lifecycle(self) -> None:
        ...
        for item in self.analyses:
            if not isinstance(item, AnalysisDocument):
                raise ProjectFormatError("project analyses must contain AnalysisDocument objects")
    ...
    def add_analysis(
        ...
        *,
        ...
        """Add one validated analysis without allowing ambiguous live identity."""
    ...
    def create_analysis(
        ...
        *,
        ...
        """Create and add an analysis with a collision-checked full UUID identity."""
        self._assert_analysis_lifecycle()
    ...
    def remove_analysis(self, analysis_id: str) -> AnalysisDocument:
        """Remove exactly one analysis, failing closed if live identity is invalid."""
        self._assert_analysis_lifecycle()
        ...
        removed = self.analyses.pop(matching_indexes[0])
...
def _allocate_analysis_id(kind: str, existing_ids: set[str]) -> str:
    """Allocate a full UUID analysis ID and verify uniqueness against live state."""
