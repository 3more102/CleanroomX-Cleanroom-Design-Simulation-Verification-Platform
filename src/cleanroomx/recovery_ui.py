...
_INTEGRITY_LABELS = {
    ...
    "legacy_unverified": "Legacy / no digest",
}
...
class RecoveryInspection:
    ...
    editor_text: str
    integrity_status: str = "Legacy / no digest"
...
class RecoveryInspectDialog(tk.Toplevel):
    def __init__(self, parent: tk.Misc, candidate: RecoveryCandidate):
        ...
        rows = (
            ...
            ("Artifact integrity", inspection.integrity_status),
...
class RecoveryCenter(tk.Toplevel):
    ...
    def __init__(self, parent: tk.Misc, scan: RecoveryScan):
        ...
        self.tree = ttk.Treeview(
            frame,
            columns=("time", "integrity", "state", "source"),
            show="tree headings",
            selectmode="browse",
        )
        self.tree.heading("#0", text="Project")
        self.tree.heading("time", text="Recovery timestamp (UTC)")
        self.tree.heading("integrity", text="Artifact integrity")
        ...
        self.tree.column("state", width=145, stretch=False)
