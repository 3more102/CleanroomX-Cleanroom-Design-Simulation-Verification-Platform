...
def test_repository_nonlinear_uncertainty_dossier_builds_end_to_end() -> None:
    ...
    assert "network-state-projection-replay" in report
    assert "network-state-projection-replay violations 0" in report
    assert "network-state-projection-replay incomplete 0" in report
