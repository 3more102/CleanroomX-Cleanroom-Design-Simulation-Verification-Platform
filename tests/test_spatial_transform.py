...
def test_model_screen_round_trip_under_pan_and_zoom():
    viewport = Viewport2D(
        width_px=1200,
        height_px=800,
        zoom=2.75,
...
def test_zoom_about_clamps_and_preserves_cursor_anchor():
...
def test_fit_viewport_centers_bounds_inside_view():
