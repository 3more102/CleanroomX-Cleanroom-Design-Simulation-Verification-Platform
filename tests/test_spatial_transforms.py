...
def test_model_screen_round_trip_is_precise(point):
    ...
    recovered = screen_to_model_2d(*screen, **VIEW)
...
def test_zoom_at_clamps_supported_range_and_rejects_invalid_factor():
    low, _, _ = zoom_2d_at(
        0.0001,
        500,
        300,
...
def test_3d_projection_is_deterministic_and_elevation_changes_screen_height():
    common = {
        "width_px": 900,
        "height_px": 600,
        "azimuth_deg": 35,
    ...
    floor = project_3d(2.0, 3.0, 0.0, **common)
    elevated = project_3d(2.0, 3.0, 2.0, **common)

    assert floor == project_3d(2.0, 3.0, 0.0, **common)
