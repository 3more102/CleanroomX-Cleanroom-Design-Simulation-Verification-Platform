...
def test_fit_views_fits_large_model_in_3d_and_resets_3d_pan() -> None:
    workspace = _workspace()
    ...
    workspace.layout["view"].update(
        {"zoom_3d": 4.0, "pan_3d_x": 125.0, "pan_3d_y": -75.0}
    )
...
def test_shift_drag_orbit_changes_camera_and_clamps_elevation() -> None:
    workspace = _workspace()
